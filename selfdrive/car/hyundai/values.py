...
class CarControllerParams:
  ...
  def __init__(self, CP):
    if CP.carFingerprint in [CAR.SONATA, CAR.PALISADE, CAR.SANTA_FE, CAR.VELOSTER, CAR.GENESIS_G70, CAR.GENESIS_G70_2020,
                             ...
                             CAR.KIA_K5_2021, CAR.KONA_EV, CAR.KONA,  CAR.KIA_NIRO_EV, CAR.IONIQ_HEV_2022, CAR.SANTA_FE_HEV_2022]:
      self.STEER_MAX = 384
    else:
      self.STEER_MAX = 255
